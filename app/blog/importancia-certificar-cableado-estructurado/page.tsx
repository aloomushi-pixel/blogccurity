      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        <article className="prose prose-slate prose-lg md:prose-xl max-w-none">
          ...
          <ul className="list-disc pl-6 space-y-4">
            <li>
              <strong>Cableado de Cobre (Cat 6 y Cat 6A):</strong> Es el estándar para llevar internet de alta velocidad y energía a estaciones de trabajo y sistemas de <Link href="/" className="text-primary hover:text-primary/80 underline transition-colors">cctv y videovigilancia</Link>. La Cat 6A es la norma corporativa actual.
            </li>
            <li>
              <strong>Fibra Óptica:</strong> Si necesitas conectar dos naves industriales o superar la barrera de los 90 metros, la <Link href="/" className="text-primary hover:text-primary/80 underline transition-colors">instalación de fibra óptica</Link> es la ruta obligatoria para tu backbone.
            </li>
          </ul>
